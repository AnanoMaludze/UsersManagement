...
namespace UsersManagement.Errors
{
    public class UsersManagementProblemDetailsFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;
        public UsersManagementProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
