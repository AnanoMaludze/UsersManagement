...
namespace UsersManagement.Repositories
{
    public interface IRepository
    {
        ...
        Task<T?> GetByIdWithIncludes<T>(int id) where T : IEntity;
        ...
        Task<List<T>> FindListAsyncWithIncludes<T>(Expression<Func<T, bool>>? expression, Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy = null, CancellationToken cancellationToken = default) where T : IEntity;
